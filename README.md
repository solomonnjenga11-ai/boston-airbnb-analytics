...
### 🔹 Correlation Heatmap (Price Drivers)
![Correlation Heatmap](images/corr_price.png)

---

### 🔹 Revenue per Day by Neighborhood
![Revenue per Day](images/revenue_by_neighborhood.png)

---

### 🔹 Price per Person by Neighborhood
![Price per Person](images/price_per_person_by_neighborhood.png)

---

### 🔹 Occupancy vs Availability
![Occupancy vs Availability](images/occupancy_vs_availability_by_neighborhood.png)

---

### 🔹 Predictors of Price
![Predictors of Price](images/predictors_price.png)

---

### 🔹 Predictors of Revenue per Day
![Predictors of Revenue](images/predictors_revenue_per_day.png)
