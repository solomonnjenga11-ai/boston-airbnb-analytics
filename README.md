...
![Correlation Heatmap](corr_price.png)

---

### 🔹 Revenue per Day by Neighborhood
![Revenue per Day](revenue_by_neighborhood.png)

---

### 🔹 Price per Person by Neighborhood
![Price per Person](price_per_person_by_neighborhood.png)

---

### 🔹 Occupancy vs Availability
![Occupancy vs Availability](occupancy_vs_availability_by_neighborhood.png)

---

### 🔹 Predictors of Price
![Predictors of Price](predictors_price.png)

---

### 🔹 Predictors of Revenue per Day
![Predictors of Revenue](predictors_revenue_per_day.png)
